...
BoidActor::BoidActor(unsigned int group, glm::vec4 color)
    : dusk::Actor()
{
    ...
    AddComponent(std::unique_ptr<dusk::Component>(new dusk::ModelComponent(std::move(model))));
    AddComponent(std::unique_ptr<dusk::Component>(new FlockingComponent()));
